                                          ...
                                          const real_T tform[16])
{
  ...
  if (absx11 < 1.0) {
    ...
    if (((int32_T)absx11 < 1) || ((int32_T)absx11 > 200)) {
      emlrtDynamicBoundsCheckR2012b((int32_T)absx11, 1, 200, &h_emlrtBCI,
                                    &c_st);
    }
    p3 = (int32_T)absx11;
  }
  ...
  if (b_bool) {
    ...
    while ((!exitg2) && (p2 <= (int32_T)absx21 - 1)) {
      ...
      if (p2 > 4) {
        emlrtDynamicBoundsCheckR2012b(5, 0, 4, &o_emlrtBCI, &c_st);
      }
                                                   ...
                                                   b_rigidBodyTree *varargin_2)
{
  ...
  if (d_obj.Length < 1.0) {
    ...
    if (((int32_T)d_obj.Length < 1) || ((int32_T)d_obj.Length > 200)) {
      emlrtDynamicBoundsCheckR2012b((int32_T)d_obj.Length, 1, 200, &h_emlrtBCI,
                                    &j_st);
    }
  ...
  if (loop_ub == 0) {
    emlrtErrorWithMessageIdR2018a(
        &j_st, &c_emlrtRTEI, "Coder:toolbox:ValidateattributesexpectedNonempty",
  ...
  if (c_obj->NumBodies >= 1.0) {
    ...
    if (bid > 0.0) {
      if (bid != (int32_T)muDoubleScalarFloor(bid)) {
        emlrtIntegerCheckR2012b(bid, &i_emlrtDCI, &g_st);
      }
      if (((int32_T)bid - 1 < 0) || ((int32_T)bid - 1 > 4)) {
        emlrtDynamicBoundsCheckR2012b((int32_T)bid - 1, 0, 4, &n_emlrtBCI,
                                      &g_st);
      }
...
void inverseKinematics_stepImpl(const emlrtStack *sp, inverseKinematics *obj,
                                const real_T tform[16],
                                const b_struct_T initialGuess[5],
                                emxArray_struct_T *QSol)
{
  ...
  while ((!exitg1) && (c_obj->RandomRestart && (err > tol))) {
    ...
    if ((exitFlag == IterationLimitExceeded) ||
      ...
      if (!(iter >= 0.0)) {
        emlrtNonNegativeCheckR2012b(iter, &wb_emlrtDCI, &d_st);
      }
      err = muDoubleScalarFloor(iter);
      if (iter != err) {
        emlrtIntegerCheckR2012b(iter, &vb_emlrtDCI, &d_st);
      }
      ...
      for (c_i = 0; c_i < i; c_i++) {
        if (((int32_T)((uint32_T)c_i + 1U) < 1) ||
            ((int32_T)((uint32_T)c_i + 1U) > 5)) {
          emlrtDynamicBoundsCheckR2012b((int32_T)((uint32_T)c_i + 1U), 1, 5,
                                        &tb_emlrtBCI, &d_st);
        }
        err = d_obj->PositionDoFMap[c_i];
        p_idx_1 = d_obj->PositionDoFMap[c_i + 5];
        if (err <= p_idx_1) {
          e_st.site = &gs_emlrtRSI;
          ...
          if (err > p_idx_1) {
            ...
            if (err != (int32_T)muDoubleScalarFloor(err)) {
              emlrtIntegerCheckR2012b(err, &mb_emlrtDCI, &d_st);
            }
            ...
            if (p_idx_1 != (int32_T)muDoubleScalarFloor(p_idx_1)) {
              emlrtIntegerCheckR2012b(p_idx_1, &lb_emlrtDCI, &d_st);
            }
  ...
  if (!(d_obj->NumBodies >= 0.0)) {
    emlrtNonNegativeCheckR2012b(d_obj->NumBodies, &rb_emlrtDCI, &b_st);
  }
  err = d_obj->NumBodies;
  if (err != (int32_T)muDoubleScalarFloor(err)) {
    emlrtIntegerCheckR2012b(err, &qb_emlrtDCI, &b_st);
  }
  ...
  if (iter == 0.0) {
    ...
    if (iter != (int32_T)muDoubleScalarFloor(iter)) {
      emlrtIntegerCheckR2012b(iter, &sb_emlrtDCI, &b_st);
    }
    if (((int32_T)iter - 1 < 0) || ((int32_T)iter - 1 > 4)) {
      emlrtDynamicBoundsCheckR2012b((int32_T)iter - 1, 0, 4, &bc_emlrtBCI,
                                    &b_st);
    }
    ...
    while (body->ParentIndex != 0.0) {
      ...
      if (body->ParentIndex !=
        ...
        emlrtIntegerCheckR2012b(body->ParentIndex, &tb_emlrtDCI, &b_st);
      }
      i = (int32_T)body->ParentIndex - 1;
      if ((i < 0) || (i > 4)) {
        emlrtDynamicBoundsCheckR2012b(i, 0, 4, &dc_emlrtBCI, &b_st);
      }
      body = d_obj->Bodies[i];
      b_i++;
    }
  ...
  if (!(iter >= 0.0)) {
    emlrtNonNegativeCheckR2012b(iter, &kb_emlrtDCI, &c_st);
  }
  ...
  for (c_i = 0; c_i < i; c_i++) {
    char_T obj_Vector[200];
    if (c_i > 4) {
      emlrtDynamicBoundsCheckR2012b(c_i, 0, 4, &gc_emlrtBCI, &b_st);
    }
    ...
    if (iter < 1.0) {
      ...
      if (((int32_T)iter < 1) || ((int32_T)iter > 200)) {
        emlrtDynamicBoundsCheckR2012b((int32_T)iter, 1, 200, &h_emlrtBCI,
                                      &d_st);
      }
      i1 = (int32_T)iter;
    }
    ...
    if (!valid) {
      if (body->Index != (int32_T)muDoubleScalarFloor(body->Index)) {
        emlrtIntegerCheckR2012b(body->Index, &pb_emlrtDCI, &b_st);
      }
      newseed_size_tmp = (int32_T)body->Index;
      if ((newseed_size_tmp < 1) || (newseed_size_tmp > 5)) {
        emlrtDynamicBoundsCheckR2012b(newseed_size_tmp, 1, 5, &xb_emlrtBCI,
                                      &b_st);
      }
      err = d_obj->PositionDoFMap[newseed_size_tmp - 1];
      p_idx_1 = d_obj->PositionDoFMap[newseed_size_tmp + 4];
      ...
      if (err > p_idx_1) {
        ...
        if (err != (int32_T)muDoubleScalarFloor(err)) {
          emlrtIntegerCheckR2012b(err, &ob_emlrtDCI, &b_st);
        }
        ...
        i1 = (int32_T)err - 1;
        if (p_idx_1 != (int32_T)muDoubleScalarFloor(p_idx_1)) {
          emlrtIntegerCheckR2012b(p_idx_1, &nb_emlrtDCI, &b_st);
        }
