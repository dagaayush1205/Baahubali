    ...
    const emxArray_real_T *x, emxArray_boolean_T *activeSet, emxArray_real_T *A)
{
  ...
  if (obj->ConstraintsOn) {
    ...
    if (activeSetCols->size[0] == obj->ConstraintBound->size[0]) {
      ...
      b_st.site = &sh_emlrtRSI;
      binary_expand_op_4(&b_st, ii, sh_emlrtRSI, activeSetCols, obj);
      ii_data = ii->data;
    }
    b_loop_ub = ii->size[0];
          ...
          *err = IKHelpers_evaluateSolution(&st, obj->ExtraArgs);
          ...
          if (guard3) {
            ...
            if (x->size[0] == a->size[0]) {
              ...
              st.site = &hj_emlrtRSI;
              costNew = binary_expand_op_2(&st, hj_emlrtRSI, x, a, obj, a__3,
                                           a__4, &r7);
              r8 = r7;
            }
            obj->ExtraArgs = r8;
                ...
                if (valid) {
                  ...
                  *err = IKHelpers_evaluateSolution(&st, obj->ExtraArgs);
                  ...
                  if (x->size[0] == a->size[0]) {
                    ...
                    st.site = &lj_emlrtRSI;
                    costNew = binary_expand_op_2(&st, lj_emlrtRSI, x, a, obj,
                                                 a__3, a__4, &r9);
                    r10 = r9;
                  }
                  obj->ExtraArgs = r10;
