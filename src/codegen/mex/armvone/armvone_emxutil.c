...
void e_emxInitStruct_robotics_manip_(const emlrtStack *sp,
                                     ...
                                     const emlrtRTEInfo *srcLocation)
{
  e_emxInitMatrix_robotics_manip_(sp, pStruct->_pobj1, srcLocation);
}
                                     ...
                                     inverseKinematics *pStruct)
{
  ...
  d_emxFreeMatrix_robotics_manip_(sp, pStruct->_pobj3);
                                     ...
                                     const emlrtRTEInfo *srcLocation)
{
  ...
  d_emxInitMatrix_robotics_manip_(sp, pStruct->_pobj3, srcLocation);
...
void f_emxFreeStruct_robotics_manip_(const emlrtStack *sp,
                                     e_robotics_manip_internal_Rigid *pStruct)
{
  e_emxFreeMatrix_robotics_manip_(sp, pStruct->_pobj1);
}
