...
void structConstructorHelper(const char_T varargin_2_f1[15],
                             const char_T varargin_2_f2[12],
                             const char_T varargin_2_f3[12],
                             const char_T varargin_2_f4[10],
                             const char_T varargin_2_f5[9],
                             const real_T varargin_4[5], b_struct_T s[5])
{
  int32_T j;
