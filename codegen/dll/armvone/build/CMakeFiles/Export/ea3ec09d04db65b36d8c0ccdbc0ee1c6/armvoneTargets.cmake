...
foreach(_cmake_expected_target IN ITEMS armvone::armvone)
...
# Create imported target armvone::armvone
add_library(armvone::armvone SHARED IMPORTED)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/armvoneTargets-*.cmake")
