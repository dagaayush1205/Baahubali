...
extern emlrtDCInfo xc_emlrtDCI;
extern emlrtBCInfo se_emlrtBCI;
...
extern const char_T cv2[10];
extern const int8_T iv[16];
extern const char_T cv3[9];
extern const char_T cv4[10];
extern const char_T cv5[10];
extern const char_T cv6[10];
extern const char_T cv7[10];
extern const char_T cv8[10];
extern const char_T cv9[10];
extern const char_T cv10[128];
extern const char_T cv11[26];
extern const char_T cv12[19];
