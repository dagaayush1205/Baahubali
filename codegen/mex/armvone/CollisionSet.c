                  ...
                  d_robotics_manip_internal_Colli *iobj_0)
{
  ...
  emlrtStack st;
  real_T t21_LocalPose[16];
  real_T t21_WorldPose[16];
  real_T d;
  int32_T b_i;
  int32_T i;
  st.prev = sp;
  ...
  for (b_i = 0; b_i < i; b_i++) {
    ...
    memcpy(&t21_LocalPose[0], &r.LocalPose[0], 16U * sizeof(real_T));
    memcpy(&t21_WorldPose[0], &r.WorldPose[0], 16U * sizeof(real_T));
    ...
    memcpy(&expl_temp.LocalPose[0], &t21_LocalPose[0], 16U * sizeof(real_T));
    memcpy(&expl_temp.WorldPose[0], &t21_WorldPose[0], 16U * sizeof(real_T));
